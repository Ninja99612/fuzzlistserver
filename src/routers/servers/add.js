...
app.post("/add", global.checkAuth, async (req,res) => {
    ...
    client.channels.cache.get('890483024284753920').send(`<:add:853596640824655872> <@${checkGuilds.ownerID}> added **${guild.name}** \n https://www.dscbots.tk/server/${checkGuilds.id}/`)
